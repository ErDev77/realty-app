...
export const translations = {
	hy: {
		...
		featuredDescription: 'Մեր փորձագետների կողմից ընտրված պրեմիում գույքեր ամենաբարձր պահանջներ ունեցող գնորդների համար',
		recentProperties: 'Նոր գույքեր',
		recentDescription: 'Մեր պորտֆելիոյի թարմ ավելացումներ - առաջինը լինեք, ով կբացահայտի այս զարմանալի հնարավորությունները',
		browseByType: 'Զննել ըստ գույքի տեսակի',
		browseDescription: 'Բացահայտեք կատարյալ գույքը, որը համապատասխանում է ձեր ապրելակերպին և ներդրումային նպատակներին',
		readyToFind: 'Պատրա՞ստ եք գտնել ձեր',
		dreamProperty: 'երազանքի գույքը',
		readyDescription: 'Միացեք հազարավոր գոհ հաճախորդների, ովքեր գտել են իրենց կատարյալ տունը մեր հարթակի միջոցով։ Ձեր երազանքի գույքը ընդամենը մեկ սեղմման հեռավորության վրա է։',
		...
		tryAdjusting: 'Փորձեք ճշգրտել ձեր զտիչները՝ ավելի շատ արդյունք տեսնելու համար:',
		filters: 'Զտիչներ',
		...
		ourTeam: 'Մեր թիմը',
		teamDescription: 'Մեր փորձառու մասնագետները կիրքով օգնում են ձեզ գտնել կատարյալ գույքը',
	...
	en: {
		...
		featuredDescription: 'Handpicked premium properties curated by our experts for the most discerning buyers',
		recentProperties: 'Recent Properties',
		recentDescription: 'Fresh additions to our portfolio - be the first to discover these amazing opportunities',
		browseByType: 'Browse by Property Type',
		browseDescription: 'Discover the perfect property that matches your lifestyle and investment goals',
		readyToFind: 'Ready to Find Your',
		dreamProperty: 'Dream Property?',
		readyDescription: 'Join thousands of satisfied customers who found their perfect home through our platform. Your dream property is just one click away.',
		...
		ourTeam: 'Our Team',
		teamDescription: 'Our experienced professionals are passionate about helping you find the perfect property',
	...
	ru: {
		...
		featuredDescription: 'Отобранная вручную премиальная недвижимость от наших экспертов для самых взыскательных покупателей',
		recentProperties: 'Новые объекты',
		recentDescription: 'Свежие пополнения в нашем портфолио - будьте первыми, кто откроет эти удивительные возможности',
		browseByType: 'Просмотр по типу недвижимости',
		browseDescription: 'Найдите идеальную недвижимость, которая соответствует вашему образу жизни и инвестиционным целям',
		readyToFind: 'Готовы найти',
		dreamProperty: 'недвижимость мечты?',
		readyDescription: 'Присоединяйтесь к тысячам довольных клиентов, которые нашли свой идеальный дом через нашу платформу. Недвижимость вашей мечты всего в одном клике.',
		...
		tryAdjusting: 'Попробуйте изменить фильтры для большего количества результатов.',
		filters: 'Фильтры',
		...
		teamDescription: 'Наши опытные профессионалы с энтузиазмом помогают найти идеальную недвижимость',
